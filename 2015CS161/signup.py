...
graph = Graph("http://localhost:11008", username="neo4j", password="123")
...
class register_user:
	...
	def createTeacher(fname , lname , country , Institute , desigination  , city  ,email, passw, num , typo , ftime , ttime ):
		...
		post=graph.run(query, rfname = tfname  , rlname = tlname  , rcounty = tcountry , rinst = tinst, rdeg = tdeg, rcity = tcity  , rregNo = tregNo , remail = temail , rpassw = tpassw , rnum = tnum , rtype = ttypo  , rftime = tftime , rttime = tttime ) 
