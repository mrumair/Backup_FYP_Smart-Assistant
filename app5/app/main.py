...
def showMember():
    ...
    memberTem= post.ObjectSelection()
...
@app.route('/dashAg')
def myFormAgX():
    return render_template('indexAg.html')
...
def myFormAg():
    ...
    text = "heyText"
    ipAg.append(textspacy.RetrieveMembers(text))
    ...
    if request.method == 'POST':
        agTitle = request.form['title']
        agDetail = request.form['detail']
        agNoOfMems = request.form['noofmems']
        agSupervisor = request.form['supervisor']
        agMembers.append(request.form['mem1'])
        agMembers.append(request.form['mem2']) 
        agMembers.append(request.form['mem3']) 
        agMembers.append(request.form['mem4']) 


        textspacy.FypFunction(agTitle, agDetail, agNoOfMems, agSupervisor, agMembers)
    ...
    return render_template('indexAg.html', ipAg=ipAg, agTitle=agTitle, agDetail=agDetail, agNoOfMems=agNoOfMems, agSupervisor=agSupervisor, agMembers=agMembers )
...
def myForm():
  ...
  #cBit6 = post.checkBit()
    ...
    #   tempS = "Please All the Time and Venue of Meeting!"
        ...
        tempPrompt = "Great! Your Meeting has been Successfully SCHEDULED!!     Do you have any AGENDA of this Meeting?"
        text_Edit = ""
        tempBitAg1 = 1
